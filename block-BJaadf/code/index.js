...
let concatFruit = fruits.concat(moreFruits);
...
numbersThree.forEach((numThree) => console.log(numThree));
...
let oddNumbers = numbersThree.map((x) => x % 2 !== 0);
console.log(oddNumbers);
// Create a new variable named evenNumbers that store all the even numbers in numbersThree array
let evenNumbers = numbersThree.map((x) => x / 2);
