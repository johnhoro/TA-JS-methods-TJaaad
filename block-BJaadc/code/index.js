...
console.log(`The last character of "${message}" is ${message.charAt(`42`)}`);
...
console.log(
  `the index of word "answers" in message is ${message.indexOf(`answer`)}`
);
...
console.log(`whether the word "is" exist in message ${message.includes("is")}`);
