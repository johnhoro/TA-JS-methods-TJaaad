...
allIs = [...strings].filter((string) => string.includes("is"));

// - Find all the words that contain 'is' use string method 'indexOf'
allIsAgain = [...strings].filter((string) => string.indexOf("is") !== -1);
...
let evenNum = [...numbers].map((num) => num % 2 === 0);
// - Find all the odd numbers
let oddNum = [...numbers].map((num) => num % 2 !== 0);

// - Place a new word at the start of the array use (unshift)
let newWord = [...strings];
newWord.unshift(`new word`);
